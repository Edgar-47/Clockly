...
def _migrate_business_foundation(connection) -> None:
    ...
    # Supports fast "all active sessions for this business" scans
    # (used by get_active_for_users and kiosk status queries).
    connection.execute(
        """
        CREATE INDEX IF NOT EXISTS idx_attendance_sessions_business_active
        ON attendance_sessions(business_id, clock_in_time DESC)
        WHERE is_active IS TRUE
        """
    )
